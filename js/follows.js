(function ($) {
    ...
    var defaultKey = 'QKqFMDVPCnskjPSQrIrjeDJ0I8P0YRFsh0HA0BRixkNVrcqL', // Unique master Xively API key to be used as a default
            defaultFeeds = [1439966730], // Comma separated array of Xively Feed ID numbers
